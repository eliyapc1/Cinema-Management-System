...
const Movie = ({ movie, renderParent, history, setKeyword, hideSearch }) => {
  ...
  return (
    <div className="movie">
      <div
        className="card mb-3"
        style={{ maxWidth: "630px", maxHeight: "295px" }}
      >
        <div className="row g-0">
          ...
          <div className="col-md-8">
            <div className="card-header">
              ...
              <p className="card-text"><span style={{color: "gray"}}>{`${genres}`}</span></p>
            </div>
            <div className="card-body" style={{ textAlign: "center" }}>

              <div className="card-text ">
                <h5>Subscribers Watched:</h5>
                <ul className="list-group list-group-flush" style={{ textAlign: "center", width: "100%", marginLeft: 0, overflowY: "scroll", height: 100 }}>
                  {!deleted ? subsRe : null}
                </ul>
              </div>
              ...
              <div className="btn-group">
                ...
                <button className="btn btn-outline-danger" onClick={deleteMovie}>
                  Delete
                </button>
              </div>
