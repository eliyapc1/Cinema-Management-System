...
const EditForm = ({ movieData, handleInput, handleCheck, sendData, errors }) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <br />
        <p>Genres: </p>
        {errors.genres ? <div className="alert alert-danger">At least one Genre is required.</div> : null}
        <div style={{
            width: "100%",
            height: 200,
            overflowY: "scroll",
        ...
        <div className="btn-group" style={{ marginLeft: 110}}>
          ...
          <NavLink className="btn btn-outline-danger" to="/movies/all">Cancel</NavLink>
        </div>
        <br />
      </form>
    </div>
